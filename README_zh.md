...
1. 下载release中的`Allure-clear.zip`或`Allure-night.zip`，然后在任意一个笔记右键，并选择“导入到笔记”
2. 导入的文件选择刚下载的文件，并**取消勾选安全导入**，然后点击“导入”

> 如何更新？
> 删除所有已安装的主题文件，并重新导入最新版即可
...
> 如何更新？
> 复制最新的css文件内容，并替换其中的 Allure-icon.woff2，如有其他字体更新，也需要替换其他字体文件
